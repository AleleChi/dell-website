            ...
            <div className="w-full px-4 sm:w-2/3 ml-6 lg:w-2/12">
              <div className="mb-10 w-full">
                ...
                <p className="dark:text-white mb-7  text-base text-body-color">
                  A citadel for knowledge and experience where every child is
                  geiven a chance for expression
                </p>
                <div className="-mx-3 flex items-center">
                  <a
                    href="javascript:void(0)"
                    className="text-dark-7 px-3 hover:text-white dark:text-white/40"
                  >
                    <svg
                      width={10}
                      height={18}
              ...
              <div className="mb-10 w-full">
                ...
                <form className="relative mb-5 w-full overflow-hidden rounded">
                  <input
                    ...
                    className="dark:text-dark-6 dark:border-dark-3 h-12 w-full rounded border border-stroke bg-transparent px-5 text-sm text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                  />
                  <button
                    type="submit"
