          ...
          <div className="container mx-auto">
            <div className="flex flex-wrap justify-center">
              <div className="w-full px-4 xl:w-10/12">
                <div className="-mx-4 mb-16 flex flex-wrap bg-primary px-5 py-14 sm:p-14  bg-green-900">
                    ...
                    <div className="mb-5 flex lg:mb-0">
                      ...
                      <div>
                        ...
                        <p className="text-base text-white/70">
                          <a
                            href="mailto: support@dellinternationalschools.com"
                            className="__cf_email__"
                          >
                            support@dellinternationalschools.com
                          </a>
                        </p>
                        <p className="text-base text-white/70">
                          <a
                            href="mailto: info@dellinternationalschools.com"
                            className="__cf_email__"
                          >
                            info@dellinternationalschools.com
                          </a>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="mb-5 flex lg:mb-0">
                      ...
                      <div>
                        ...
                        <p className="text-base text-white/70">
                          Along Madonna Way, Behind NTA Asaba
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="w-full px-4 md:w-1/2">
                        <div className="mb-7">
                          <input
                            ...
                            className="dark:border-dark-3 dark:text-dark-6 w-full border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary"
                          />
                        </div>
                      </div>
                      <div className="w-full px-4 md:w-1/2">
                      ...
                      <div className="w-full px-4">
                        <div className="mb-7">
                          <textarea
                            ...
                            rows={6}
                            className="dark:border-dark-3 dark:text-dark-6 w-full resize-none border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary"
                            defaultValue={""}
                          />
                        </div>
                      </div>
